...
- (void)viewDidLoad {
    ...
    StringTemplate *htmlTemplate = [[[StringTemplate alloc] initWithTemplateName:@"Post.html"] autorelease];
...
- (UIView *)tableView:(UITableView *)aTableView viewForHeaderInSection:(NSInteger)section {
    UIImageView *background = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"DropShadow.png"]] autorelease];
